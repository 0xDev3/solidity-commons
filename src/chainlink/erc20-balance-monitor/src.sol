// File: contracts/src/v0.8/vendor/openzeppelin-solidity/v4.7.0/contracts/utils/Address.sol
...
// File: contracts/src/v0.8/vendor/openzeppelin-solidity/v4.7.0/contracts/token/ERC20/extensions/IERC20Permit.sol
...
// File: contracts/src/v0.8/vendor/openzeppelin-solidity/v4.7.0/contracts/token/ERC20/IERC20.sol
...
// File: contracts/src/v0.8/vendor/openzeppelin-solidity/v4.7.0/contracts/token/ERC20/utils/SafeERC20.sol
...
// File: contracts/src/v0.8/vendor/openzeppelin-solidity/v4.7.0/contracts/utils/Context.sol
...
// File: contracts/src/v0.8/vendor/openzeppelin-solidity/v4.7.0/contracts/security/Pausable.sol
...
// File: contracts/src/v0.8/interfaces/automation/AutomationCompatibleInterface.sol
...
// File: contracts/src/v0.8/interfaces/automation/KeeperCompatibleInterface.sol
...
// File: contracts/src/v0.8/automation/upkeeps/ERC20BalanceMonitor.sol
 ...
 */
contract ERC20BalanceMonitor is
    ConfirmedOwner,
    Pausable,
    KeeperCompatibleInterface
{
    ...
    function topUp(address[] memory needsFunding) public whenNotPaused {
        ...
        for (uint256 idx = 0; idx < needsFunding.length; idx++) {
            ...
            uint256 targetTokenBalance = s_erc20Token.balanceOf(
                needsFunding[idx]
            );
            if (
                target.isActive &&
